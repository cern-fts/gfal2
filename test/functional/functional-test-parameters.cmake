...
IF(PLUGIN_FILE)
        ...
        gfal_test_rename("FILE" "file://${file_base_path}")
        ...
        rwt_test_seek("FILE" ${file_prefix} 100 4560)
...
IF(PLUGIN_SRM)
        ...
        # Rename test
        gfal_test_rename("SRM_DPM" ${srm_prefix_dpm})
        gfal_test_rename("SRM_DCACHE" ${srm_prefix_dcache})
        # checksum tests
...
IF(PLUGIN_GRIDFTP)
        ...
        gfal_test_rename("GRIDFTP" ${gsiftp_prefix_dpm})
...
IF(PLUGIN_HTTP)
        ...
        gfal_test_rename("DAVS" ${davs_valid_dir_root})
        # chmod not supported
...
IF(PLUGIN_XROOTD)
    ...
    gfal_test_rename("XROOTD" ${root_valid_dir_root})

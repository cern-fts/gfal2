...
gfal_file_handle gfal_dcap_openG(plugin_handle handle, const char* path,
 ...
 */
ssize_t gfal_dcap_preadG(plugin_handle handle, gfal_file_handle fd, void* buff,
 ...
 */
ssize_t gfal_dcap_pwriteG(plugin_handle handle, gfal_file_handle fd,
...
off_t gfal_dcap_lseekG(plugin_handle handle, gfal_file_handle fd, off_t offset,
...
ssize_t gfal_dcap_writeG(plugin_handle handle, gfal_file_handle fd,
...
int gfal_dcap_statG(plugin_handle handle, const char* name, struct stat* buff,
        GError ** err)
{
    gfal_plugin_dcap_handle h = (gfal_plugin_dcap_handle) handle;
...
int gfal_dcap_lstatG(plugin_handle handle, const char* name, struct stat* buff,
        GError ** err)
{
    gfal_plugin_dcap_handle h = (gfal_plugin_dcap_handle) handle;
...
int gfal_dcap_accessG(plugin_handle plugin_data, const char* url, int mode,
        GError** err)
{
...
int gfal_dcap_mkdirG(plugin_handle handle, const char* name, mode_t mode,
...
int gfal_dcap_chmodG(plugin_handle handle, const char* name, mode_t mode,
        GError** err)
{
    gfal_plugin_dcap_handle h = (gfal_plugin_dcap_handle) handle;
...
gfal_file_handle gfal_dcap_opendirG(plugin_handle handle, const char* path,
        GError ** err)
{
    gfal_plugin_dcap_handle h = (gfal_plugin_dcap_handle) handle;
    ...
    if (d == NULL) {
        ...
        ret = gfal_file_handle_new2(gfal_dcap_getName(), (gpointer) d, NULL,
                path);
    }
    return ret;
}
...
struct dirent* gfal_dcap_readdirG(plugin_handle handle, gfal_file_handle fh,
        GError** err)
{
    gfal_plugin_dcap_handle h = (gfal_plugin_dcap_handle) handle;

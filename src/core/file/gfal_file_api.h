...
*/
/**
 * @file gfal_file_api.h
 * @brief Main File operation and file management API
...
///  @param err : GError error report
///  @return pointer to a dirent struct if success, NULL if end of listing or error, set err properly in case of error
///
